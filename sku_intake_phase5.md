...
|---|---|
| Intake ID | `FRG-01` |
| Public Product Name | Dior Sauvage Parfum Spray for Men |
| Suggested Website Title | Dior Sauvage Parfum Spray for Men 100ml / 3.4 oz |
| Public Brand Display | Dior — user explicitly authorised use for this SKU in the current round. |
| SKU | `FR-DI-SAU-100` |
| Category | Fragrance |
| Product Type | Men’s Perfume |
| Concentration | Parfum |
| Size / Volume | 100 ml / 3.4 oz |
| Gender | Men |
| Private Label | Yes |
...
| Key Notes | Bergamot / Pepper / Amber Wood |
| Confirmed Product Copy | A bold woody fragrance with a fresh masculine signature. Sauvage combines bright bergamot freshness with pepper and warm amber wood, creating a powerful fragrance profile designed for men who prefer fresh, woody and sophisticated scents. |
| Packaging Details | Dark navy-to-black gradient glass perfume bottle with black cylindrical cap, paired with matching premium black retail box. |
| Product Image | `/home/ubuntu/upload/pasted_file_WYcLiB_image.png` — user-supplied screenshot; crop to bottle and box only so no original retail-site UI appears on TopPerfume. |
| Retail UI Exclusions | Do not reproduce US$165 retail price, Shop Pay, Add to Cart, Shipping calculated at checkout, payment prompts, checkout controls or original retailer layout. |
...
|---|---|
| Intake ID | `FRG-02` |
| Public Product Name | `Layering Discovery Set [NAME TO CONFIRM]` — a neutral working name only; formal public name remains subject to user confirmation. |
| Public Brand Display | GUIQI — user confirmed the brand may be displayed publicly. |
| Category | Fragrance |
| Product Type | Fragrance Layering Discovery Set |
| Size / Volume | 7 × 1.7 mL |
...
| Standard Lead Time | Approx. 7 days |
| Sample Availability | Free samples available |
| Fragrance / Formula | `[TO CONFIRM]` — visible fragrance-name text is not copied into public data without explicit approval. |
