...
export default function Collection() {
  ...
  return <SiteShell>
    ...
    <section className="collection-cta"><div><p className="eyebrow">NEED A DIFFERENT FORMAT?</p><h2>Move from product selection to quote.</h2><p>{catalogueMoqGuidance} Each product detail page shows its own confirmed MOQ and lead time. Contact us for details on customization terms.</p></div><InquiryDrawer triggerLabel="Get a Project Quote" intent="quote" context={{ category }} /></section>
