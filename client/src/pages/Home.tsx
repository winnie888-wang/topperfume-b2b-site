...
export default function Home() {
  return <SiteShell>
    <section className="hero-section hero-refined hero-luxe"><div className="hero-copy"><p className="eyebrow">BEAUTY PRODUCT DEVELOPMENT &amp; MANUFACTURING</p><h1>Beauty products<br /><em>built for your brand.</em></h1><p className="hero-intro">We are a B2B partner for beauty brands developing and manufacturing <strong>Fragrance, Skincare and Makeup</strong>—through <strong>Private Label, OEM and ODM</strong>.</p><p className="hero-editorial-note">Make the product the reason to begin.</p><div className="hero-b2b-line"><span>FRAGRANCE</span><span>SKINCARE</span><span>MAKEUP</span><span>PRIVATE LABEL</span><span>OEM</span><span>ODM</span></div><div className="hero-actions"><Link href="#products" className="text-link">Browse Products <ArrowRight size={16} /></Link><InquiryDrawer triggerLabel="Start Your Project" /></div></div><figure className="hero-product-stage hero-single-stage"><img className="hero-single-image" src="/manus-storage/topperfume-hero-single-fragrance-editorial_ca1e5ee2.png" alt="Authorized single fragrance product reference on travertine and translucent glass" /><figcaption className="hero-visual-note">Authorized fragrance reference · product title [NAME TO CONFIRM]</figcaption></figure></section>
