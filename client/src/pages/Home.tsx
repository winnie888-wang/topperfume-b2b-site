...
const categoryEntries: { category: ProductCategory; title: string; intro: string; href: string }[] = [
  ...
  { category: "skincare", title: "Skincare", intro: "Care formats, routine products and development options.", href: "/collections/skincare" },
...
const buyerEvidence = [
  ...
  ["Production", "Low MOQ is available, with product-specific order terms shown on each SKU."],
