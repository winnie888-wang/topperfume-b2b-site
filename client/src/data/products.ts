...
export const products: Product[] = [
  ...
  { slug: "jergens-ultra-healing-body-lotion", name: "Jergens Ultra Healing Body Lotion", category: "skincare", format: "946 ml / 32 fl oz", descriptor: "Vitamin C · E · B5", image: realVisual.jergensUltraHealingLotion, realImage: true, tags: ["Body Care", "Intensive Moisturizer", "Pump Bottle"], briefing: "Intensive daily moisture for extra dry skin. Jergens Ultra Healing Body Lotion is positioned as a rich daily moisturizer for extra dry skin. The formula contains Vitamins C, E and B5 and is designed to provide intensive hydration while helping skin feel softer, smoother and more comfortable. Its fast-absorbing formula and large 946 ml pump format make it suitable for everyday body-care routines and high-volume retail body-lotion collections.", sku: "SK-BL-JER-UH-946", b2bPrice: "[TO CONFIRM]", productType: "Intensive Moisturizing Body Lotion / Dry Skin Body Care", primaryBenefit: "Moisturizing · Hydrating · Smoothing", keyIngredients: "Vitamin C · Vitamin E · Vitamin B5", texture: "Fast-absorbing lotion", skinType: "Extra Dry Skin", dermatologistTested: "Yes — according to supplied product information", fragrance: "[TO CONFIRM]", standardMoq: "[TO CONFIRM]", leadTime: "Approx. 7 days", packaging: "Large white pump bottle with clean minimal packaging and orange accent design.", dataStatus: "confirmed" },
