// Reviewed intake from docs/intake/combined-listing. IDs identify source records, not supplier SKUs.
import type { Product } from "./products";

export const combinedListingProducts: Product[] = [
  {
  ...
  },
  {
    ...
    "name": "KAYALI Oudgasm Café Oud | 19",
    "category": "fragrance",
    "productType": "Fragrance",
    "format": "100 mL / 3.4 FL OZ",
    "descriptor": "Fragrance",
    ...
    "gallery": [
      {
        ...
        "width": 756,
        "height": 1280,
        "alt": "Dark faceted bottle with gold lettering and matching dark box — KAYALI Oudgasm Café Oud | 19",
        "label": "Supplied photo"
      }
    ],
    "commercialType": "Wholesale",
    ...
    "briefing": "KAYALI Oudgasm Café Oud | 19. US$5.00 per piece with a minimum order of 2 pieces. Packaging marked 100 mL / 3.4 FL OZ. Contact us for product specifications and order details.",
    "realImage": true,
    "dataStatus": "confirmed",
    "sourceBatch": "03",
    "intakeIds": [
    ...
    "seoDescription": "KAYALI Oudgasm Café Oud | 19. US$5.00 per piece with a minimum order of 2 pieces. Packaging marked 100 mL / 3.4 FL OZ. Contact us for product specifications and order details.",
    "minimumOrderQuantity": 2,
    "standardMoq": "2 pieces",
    "labelInformation": [
