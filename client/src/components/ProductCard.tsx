...
export function ProductCard({ product, index }: { product: Product; index: number }) {
  const customField = product.customizationStatus || getCustomizationLabel(product.category);
